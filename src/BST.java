// Anya Kothari
// 4/08/24
// This program can search, traverse, and insert a node into a binary tree
...
public class BST {
    ...
    public boolean treeSearch(int val, BSTNode root) {
        ...
        // Compare val and the current node
        if (val < currentNode.getVal()) {
    ...
    public ArrayList<BSTNode> getInorder() {
        ...
        // Call the recursive method to return the inorder traversal
    ...
    public ArrayList<BSTNode> getPostorder() {
        ...
        // Call the recursive method to return the postorder traversal
    ...
    public ArrayList<BSTNode> traversalInOrder(BSTNode root) {
        ...
        // Create an ArrayList to temporarily hold results from the recursive calls
    ...
    public ArrayList<BSTNode> traversalPreOrder(BSTNode root) {
        ...
        ArrayList<BSTNode> preOrdered = new ArrayList<BSTNode>();
        // Create an ArrayList to temporarily hold results from the recursive calls
        ArrayList<BSTNode> temp = new ArrayList<BSTNode>();
        BSTNode currentNode = root;
        // If there is no node
    ...
    public ArrayList<BSTNode> traversalPostOrder(BSTNode root) {
        ArrayList<BSTNode> postOrdered = new ArrayList<BSTNode>();
        ArrayList<BSTNode> temp = new ArrayList<BSTNode>();
        BSTNode currentNode = root;
        // If there is no node
        if (currentNode == null) {
        ...
        // Add the root after both the left subtree the right subtree
